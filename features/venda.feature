Feature: CRUD Venda
  ...
  Scenario: criar venda com cliente vazio
    Given Eu tenho um produto com nome "Xiaomi Mi 8 lite", com quantidade "1", com preco "1000.00" e com tipo "Celular"
    And Eu abro a pagina de cadastrar venda
    When Eu cadastro a venda com o produto "Xiomi Mi 8 Lite" e o preço de servico "150.00"
  ...
  Scenario: criar venda com produto vazio
    ...
    And Eu abro a pagina de cadastrar venda
    When Eu cadastro a venda com o cliente com nome "Victor Raffaele" e o preço de servico "150.00"
  ...
  Scenario: criar venda com preco de servico inválido
    ...
    And Eu tenho um cliente com nome "Victor Raffaele", cpf "102.209.194-88" e telefone "83995369280"
    And Eu abro a pagina de cadastrar venda
    When Eu cadastro a venda com o cliente com nome "Victor Raffaele", o produto "Xiomi Mi 8 Lite" e o preço de servico "asda"
    Then Eu vejo uma mensagem informando que o preco referente a venda e invalido.

  Scenario: criar venda com preco de servico com valor incoerente
    Given Eu tenho um produto com nome "Xiaomi Mi 8 lite", com quantidade "1", com preco "1000.00" e com tipo "Celular"
    And Eu tenho um cliente com nome "Victor Raffaele", cpf "102.209.194-88" e telefone "83995369280"
    And Eu abro a pagina de cadastrar venda
    When Eu cadastro a venda com o cliente com nome "Victor Raffaele", o produto "Xiomi Mi 8 Lite" e o preço de servico "15000000000000000000000.00"
    Then Eu vejo uma mensagem informando que o valor do servico esta incoerente