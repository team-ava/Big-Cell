...
class VendasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create venda" do
    assert_difference('Venda.count') do
      post vendas_url, params: { venda: { valorProduto: @venda.valorProduto, valorServico: @venda.valorServico } }
    end
  ...
  test "should update venda" do
    patch venda_url(@venda), params: { venda: { valorProduto: @venda.valorProduto, valorServico: @venda.valorServico } }
